// Servidor Express para processar webhooks do WhatsApp via n8n
...
// Endpoint para receber webhooks do WhatsApp via n8n
app.post('/api/ia-whatsapp/process', async (req, res) => {
  try {
...
app.listen(PORT, () => {
  ...
  console.log(`Endpoint para n8n: http://localhost:${PORT}/api/ia-whatsapp/process`);
});
