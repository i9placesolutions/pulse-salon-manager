...
import { BlockedTime, RPCReturnTypes } from "@/types/supabase";
...
const Appointments = () => {
  ...
  const fetchExistingBlocks = async () => {
    try {
      ...
      // Utilizando a função genérica para buscar bloqueios
      const { data, error } = await supabase
        .rpc('get_blocked_times', {
          establishment_id_input: '123e4567-e89b-12d3-a456-426614174000' // ID do estabelecimento (exemplo)
        }) as { data: BlockedTime[], error: any };
