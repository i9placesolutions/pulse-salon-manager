...
import { Clock, AlertTriangle, XCircle, AlertCircle, ChevronDown, ChevronUp } from "lucide-react";
...
export function FinancialAlerts({ 
  ...
  useEffect(() => {
    // Função para processar a data em diferentes formatos
    const parseDate = (dateStr: string): Date | null => {
      // Tentativa de parse direta
    ...
    const combinedAlerts = [...expenseAlerts, ...receivableAlerts].sort((a, b) => {
