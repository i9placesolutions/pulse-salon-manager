...
const menuItems: MenuItem[] = [
  ...
  { icon: PackageOpen, label: "Estoque", path: "/estoque", category: "principal" },
  ...
  { icon: Bot, label: "IA WhatsApp", path: "/iawhatsapp", category: "principal" },
...
const menuItemColors = {
  ...
  "/profissionais": { color: "text-pink-600", bg: "bg-pink-100", hover: "hover:bg-pink-100" },
  "/financeiro": { color: "text-green-600", bg: "bg-green-100", hover: "hover:bg-green-100" },
  "/pdv": { color: "text-rose-600", bg: "bg-rose-100", hover: "hover:bg-rose-100" },
  "/estoque": { color: "text-yellow-600", bg: "bg-yellow-100", hover: "hover:bg-yellow-100" },
  "/relatorios": { color: "text-cyan-600", bg: "bg-cyan-100", hover: "hover:bg-cyan-100" },
  "/marketing": { color: "text-red-600", bg: "bg-red-100", hover: "hover:bg-red-100" },
  "/iawhatsapp": { color: "text-indigo-600", bg: "bg-indigo-100", hover: "hover:bg-indigo-100" },
