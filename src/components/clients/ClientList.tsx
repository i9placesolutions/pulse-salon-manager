                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        {isTodayBirthday && (
                          <Badge className="bg-pink-100 text-pink-800 hover:bg-pink-100 animate-pulse">
                            <Cake className="h-3 w-3 mr-1 text-pink-600" />
                            Hoje
                          </Badge>
                        )}
                        {client.cashback > 0 && (
                  ...
                  <div className="flex flex-col sm:flex-row items-center gap-2 ml-auto mt-4 md:mt-0">
                    {showBirthdayInfo && (
                      <Button
                        variant="outline"
                        size="sm"
                        className="rounded-full bg-pink-50 text-pink-700 border-pink-200 hover:bg-pink-100 w-full sm:w-auto"
