...
export const mockPerformance: ProfessionalPerformance = {
...
export const mockCommissions: ProfessionalCommission[] = [
  {
    id: 1,
...
export const mockAppointments: ProfessionalAppointment[] = [
  {
    id: 1,
    date: "2024-03-07",
